...
public class FotoRepuesto {
    ...
    public byte[] miFoto(int id){
        ...
        try {
            ...
            myPstat = myConn.con.prepareStatement("SELECT foto FROM repuestos WHERE idrepuesto = ?");
            myPstat.setInt(1, id);
            ...
            Logger.getLogger(FotoRepuesto.class.getName()).log(Level.SEVERE, null, ex);
            foto = null;
        }
        return foto;
    }
